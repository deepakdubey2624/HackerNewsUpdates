...
class Home extends Component {
  ...
  showUrl = (params) => {
    // console.log(params);
    return `<a href="${params.data.uri}" target="_blank">Click to view the link</a>`
  }
      ...
      this.setState({
        ...
        fetch('/api/data')
          ...
          .then(data => {
            ...
            this.setState({ list: data }, () => console.log("Data Fetched"));
          })
          .catch(err => {
            console.error(err);
  ...
  render() {
    ...
    const mainContent = this.state.authenticated && this.state.list !== null ? (
      <div className="ag-theme-alpine"
        ...
        <p>You have entered the news portal </p>

        <div className="float-none">
          <button className="btn btn-light btn-lg" onClick={this.updateData}>Mark as Read</button>
